...
/***/ "./node_modules/apollo-link-batch-http/lib/bundle.esm.js":
/*!***************************************************************!*\
  !*** ./node_modules/apollo-link-batch-http/lib/bundle.esm.js ***!
  \***************************************************************/
...
/* harmony import */ var apollo_link_batch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! apollo-link-batch */ "./node_modules/apollo-link-batch/lib/bundle.esm.js");
...
var BatchHttpLink = (function (_super) {
    ...
    function BatchHttpLink(fetchParams) {
        var _this = _super.call(this) || this;
        var _a = fetchParams || {}, _b = _a.uri, uri = _b === void 0 ? '/graphql' : _b, fetcher = _a.fetch, includeExtensions = _a.includeExtensions, batchInterval = _a.batchInterval, batchMax = _a.batchMax, batchKey = _a.batchKey, requestOptions = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, ["uri", "fetch", "includeExtensions", "batchInterval", "batchMax", "batchKey"]);
        ...
        var batchHandler = function (operations) {
            var chosenURI = Object(apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["selectURI"])(operations[0], uri);
            ...
            var contextConfig = {
                ...
                headers: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, clientAwarenessHeaders, context.headers),
            };
            var optsAndBody = operations.map(function (operation) {
                return Object(apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["selectHttpOptionsAndBody"])(operation, apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["fallbackHttpConfig"], linkConfig, contextConfig);
            });
            ...
            if (options.method === 'GET') {
                return Object(apollo_link__WEBPACK_IMPORTED_MODULE_1__["fromError"])(new Error('apollo-link-batch-http does not support GET requests'));
            }
            try {
                options.body = Object(apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["serializeFetchParameter"])(loadedBody, 'Payload');
            }
            catch (parseError) {
            ...
            var controller;
            if (!options.signal) {
                var _b = Object(apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["createSignalIfSupported"])(), _controller = _b.controller, signal = _b.signal;
            ...
            return new apollo_link__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (observer) {
                fetcher(chosenURI, options)
                    ...
                    .then(Object(apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["parseAndCheckHttpResponse"])(operations))
                    .then(function (result) {
        ...
        batchKey =
            batchKey ||
                (function (operation) {
                    ...
                    return Object(apollo_link_http_common__WEBPACK_IMPORTED_MODULE_2__["selectURI"])(operation, uri) + JSON.stringify(contextConfig);
                });
        _this.batcher = new apollo_link_batch__WEBPACK_IMPORTED_MODULE_3__["BatchLink"]({
...
/***/ "./node_modules/apollo-link-batch/lib/bundle.esm.js":
/*!**********************************************************!*\
  !*** ./node_modules/apollo-link-batch/lib/bundle.esm.js ***!
  \**********************************************************/
/*! exports provided: BatchLink, OperationBatcher */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var OperationBatcher = (function () {
    ...
    OperationBatcher.prototype.enqueueRequest = function (request) {
        ...
        if (!requestCopy.observable) {
            requestCopy.observable = new apollo_link__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (observer) {
    ...
    OperationBatcher.prototype.consumeQueue = function (key) {
        ...
        var batchedObservable = this.batchHandler(requests, forwards) || apollo_link__WEBPACK_IMPORTED_MODULE_1__["Observable"].of();
        var onError = function (error) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/UpdateUserComponent.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/UpdateUserComponent.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************/
  ...
  Vue.mixin(_objectSpread2({}, vueVersion === '1' ? {
    ...
    serverPrefetch: function serverPrefetch() {
      ...
      if (this.$_apolloPromises) {
        return Promise.all(this.$_apolloPromises).then(function (result) {
...
ApolloProvider.version = "3.0.0"; // Apollo provider
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true& ***!
  \**********************************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex flex-col items-center p-8" }, [
    _c("div", { staticClass: "p-8" }, [
      _c("p", [_vm._v("---Mutation update user trigger here---")]),
      _vm._v(" "),
      _c("label", [_vm._v("User updated:")]),
      _vm._v(" "),
...
/* harmony import */ var apollo_link_batch_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! apollo-link-batch-http */ "./node_modules/apollo-link-batch-http/lib/bundle.esm.js");
...
/* harmony import */ var _echo_link__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./echo.link */ "./resources/js/echo.link.js");
...
var batchHttpLink = new apollo_link_batch_http__WEBPACK_IMPORTED_MODULE_3__["BatchHttpLink"]({
  uri: '/graphql',
  ...
  function () {
    ...
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(uri, options) {
      var token;
...
var echoLink = new _echo_link__WEBPACK_IMPORTED_MODULE_6__["default"]();
var apolloClient = new apollo_client__WEBPACK_IMPORTED_MODULE_2__["default"]({
  link: apollo_link__WEBPACK_IMPORTED_MODULE_5__["ApolloLink"].from([echoLink, batchHttpLink]),
  cache: cache,
  defaultOptions: {
    watchQuery: {
      errorPolicy: 'all'
...
var apollo = new vue_apollo__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
/* harmony import */ var vue_apollo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-apollo */ "./node_modules/vue-apollo/dist/vue-apollo.esm.js");
/* harmony import */ var _apollo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./apollo */ "./resources/js/apollo.js");



vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_apollo__WEBPACK_IMPORTED_MODULE_1__["default"]);
vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default.a.component('user-update-component', __webpack_require__(/*! ./components/UpdateUserComponent */ "./resources/js/components/UpdateUserComponent.vue")["default"]);
var app = new vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app',
  apolloProvider: _apollo__WEBPACK_IMPORTED_MODULE_2__["apollo"]
});

/***/ }),

/***/ "./resources/js/components/UpdateUserComponent.vue":
/*!*********************************************************!*\
  !*** ./resources/js/components/UpdateUserComponent.vue ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _UpdateUserComponent_vue_vue_type_template_id_43014c8e_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true& */ "./resources/js/components/UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true&");
/* harmony import */ var _UpdateUserComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UpdateUserComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/UpdateUserComponent.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _UpdateUserComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _UpdateUserComponent_vue_vue_type_template_id_43014c8e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _UpdateUserComponent_vue_vue_type_template_id_43014c8e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "43014c8e",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/UpdateUserComponent.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/UpdateUserComponent.vue?vue&type=script&lang=js&":
/*!**********************************************************************************!*\
  !*** ./resources/js/components/UpdateUserComponent.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_UpdateUserComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./UpdateUserComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/UpdateUserComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_UpdateUserComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true&":
/*!****************************************************************************************************!*\
  !*** ./resources/js/components/UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true& ***!
  \****************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_UpdateUserComponent_vue_vue_type_template_id_43014c8e_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/UpdateUserComponent.vue?vue&type=template&id=43014c8e&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_UpdateUserComponent_vue_vue_type_template_id_43014c8e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_UpdateUserComponent_vue_vue_type_template_id_43014c8e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/echo.link.js":
/*!***********************************!*\
  !*** ./resources/js/echo.link.js ***!
  \***********************************/
/*! exports provided: default */
...
/* harmony import */ var laravel_echo_dist_echo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! laravel-echo/dist/echo */ "./node_modules/laravel-echo/dist/echo.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_ApolloLink) {
  _inherits(EchoLink, _ApolloLink);

  function EchoLink() {
    var _this;

    _classCallCheck(this, EchoLink);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EchoLink).call(this));
    var token = localStorage.getItem('token');
    _this.subscriptions = [];
    _this.echo = new laravel_echo_dist_echo__WEBPACK_IMPORTED_MODULE_1__["default"]({
      broadcaster: 'pusher',
      key: "4ba361ad175dd3aa1dea",
      cluster: "ap1",
  ...
  _createClass(EchoLink, [{
      ...
      return new apollo_link__WEBPACK_IMPORTED_MODULE_0__["Observable"](function (observer) {
        ...
        forward(operation).subscribe({
          next: function next(data) {
            ...
            var subscriptionChannel = _this2._getChannel(data, operation);
    ...
    key: "_getChannel",
    value: function _getChannel(data, operation) {
    ...
    value: function _createSubscription(subscriptionChannel, observer) {
      ...
      var privateChannelName = subscriptionChannel.split('private-').pop();

      if (!this.subscriptions.find(function (s) {
        return s.channel === subscriptionChannel;
      })) {
      ...
      this.echo["private"](privateChannelName).listen('.lighthouse-subscription', function (payload) {
        if (!payload.more || observer._subscription._state === 'closed') {
          _this3._leaveSubscription(subscriptionChannel, observer);
    ...
    key: "_leaveSubscription",
    value: function _leaveSubscription(channel, observer) {
      var subscription = this.subscriptions.find(function (s) {
...
/* harmony default export */ __webpack_exports__["default"] = (EchoLink);
...
__webpack_require__(/*! C:\xampp\htdocs\graphql-api\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\graphql-api\resources\sass\app.scss */"./resources/sass/app.scss");
